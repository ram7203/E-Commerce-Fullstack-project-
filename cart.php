    ...
    <section class="products">
        ...
        <div class="box-container">
            ...
            <form action="" method="post" class="box">
                ...
                <input type="submit" value="delete item" onclick="return confirm('Do you want to delete item from cart?');" name="delete" class="delete-btn">
            </form>
        ...
        <div class="grand-total">
            ...
            <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total>1)?'':'disabled'; ?>" onclick="return confirm('Do you want to delete all items from cart?');">delete all</a>
